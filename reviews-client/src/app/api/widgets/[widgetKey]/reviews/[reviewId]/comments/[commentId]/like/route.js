// app/api/widgets/[widgetKey]/reviews/[reviewId]/comments/[commentId]/like/route.js
...
export async function POST(req, ctx) {
    ...
    // комментарий принадлежит отзывам нашего виджета
    ...
    // если нет - вставляем, если есть - меняем реакцию на like
