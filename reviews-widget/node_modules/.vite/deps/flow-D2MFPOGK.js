...
var MetricsCache = class {
  ...
  update(metrics, direction) {
    ...
    for (const k of marginsToUpdate) {
      const a = ((_a = this._metricsCache.get(k)) == null ? void 0 : _a[leadingMargin(direction)]) || 0;
      const b = ((_b = this._metricsCache.get(k - 1)) == null ? void 0 : _b[trailingMargin(direction)]) || 0;
  ...
  getLeadingMarginValue(index, direction) {
    var _a;
    return ((_a = this._metricsCache.get(index)) == null ? void 0 : _a[leadingMargin(direction)]) || 0;
  }
  getChildSize(index) {
...
@lit-labs/virtualizer/layouts/flow.js:
   ...
   *)
*/
//# sourceMappingURL=flow-D2MFPOGK.js.map
